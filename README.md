...
*rasterdiv* is a package for the R statistical software and environment. It aims to provide functions to apply Information Theory based diversity indexes, such as Shannon's entropy or Cumulative Residual Entropy (CRE), on RasterLayer or numerical matrices.
