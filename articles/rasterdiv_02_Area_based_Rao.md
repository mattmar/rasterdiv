...
This vignette uses **rasterdiv** to derive classic and multidimension
area-based Rao’s index from an input vector layer and multiple raster
layers.
...
original dataset was resampled to 1/10th of its spatial resolution and
