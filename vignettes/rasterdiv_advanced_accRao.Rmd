...
knitr::opts_chunk$set(fig.dpi = 150, collapse = FALSE, comment = "#")
...
Pixels with NDVI values higher than 150 will be decreased using values from a normal distribution centered on 50 with a standard deviation of 5.
...
Now we need a simple function that calculates parameteric Rao's Index over a vector of NDVI values
```{r results='hide', message=FALSE, warning=FALSE }
